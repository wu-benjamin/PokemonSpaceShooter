...
public enum Location {
    ...
    MOON        (7, "Mt. Moon", 50, Pokemon.CLEFABLE, "Cave", "Navigate through Mount Moon!", "You made it through Mount Moon!", Pokemon.ZUBAT,Pokemon.GEODUDE, Pokemon.PARAS, Pokemon.SANDSHREW, Pokemon.CLEFAIRY),
    ...
    CERULEAN    (11, "Cerulean City Gym", 30, Pokemon.STARMIE, "Pool", "Fight Gym Leader Misty!", "You earned the Cascade Badge!",Pokemon.STARYU, Pokemon.GOLDEEN, Pokemon.PSYDUCK, Pokemon.MAGIKARP),
    ...
    SAFFRON     (28, "Saffron City Gym", 70, Pokemon.ALAKAZAM, "GoldByzantine", "Defeat Sabrina,\nthe psychic Gym Leader!", "You earned the Soul Badge!", Pokemon.ABRA, Pokemon.KADABRA, Pokemon.JYNX, Pokemon.MRMIME, Pokemon.PSYDUCK, Pokemon.GOLDUCK, Pokemon.VENOMOTH, Pokemon.VENONAT, Pokemon.SLOWBRO, Pokemon.SLOWPOKE),
    ...
    ROUTE20     (41, "Route 20", 100, Pokemon.MISSINGNO, "Sea", "Head east to Cinnabar!", "You made it to Cinnabar Island!", Pokemon.GYARADOS, Pokemon.TENTACOOL, Pokemon.MAGIKARP, Pokemon.POLIWAG, Pokemon.GOLDEEN, Pokemon.SHELLDER, Pokemon.HORSEA, Pokemon.STARYU, Pokemon.TENTACRUEL),
    MANSION     (42, "Pokemon Mansion", 110, Pokemon.MEW, "Carpet", "Investigate the lost experiments\nof the Pokemon Mansion!", "Excellent investigating!", Pokemon.MAGMAR, Pokemon.PONYTA, Pokemon.KOFFING, Pokemon.GROWLITHE, Pokemon.VULPIX, Pokemon.GRIMER, Pokemon.WEEZING, Pokemon.MUK, Pokemon.RATTATA, Pokemon.RATICATE, Pokemon.DITTO, Pokemon.KABUTO, Pokemon.KABUTOPS, Pokemon.OMANYTE, Pokemon.OMASTAR, Pokemon.AERODACTYL),
